...
def send_start(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
	bot.send_message(message.chat.id, f"__👋 مرحبا **{message.from_user.mention}**, انا بوت حفظ المنشورات من القنوات المقيدة ارسل لي رابط المنشور",
	reply_markup=InlineKeyboardMarkup([[ InlineKeyboardButton("السورس", url="https://t.me/Source_Ze")]]), reply_to_message_id=message.id)
